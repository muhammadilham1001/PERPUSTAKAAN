        ...
        <div class="col-12 hero-text-image">
          <div class="row">
            <div class="col-lg-8 text-center text-lg-start">
              <h1 data-aos="fade-right">Jendela Menuju Pengetahuan </h1>
              <p class="mb-5" data-aos="fade-right" data-aos-delay="100">Jadi, mari berpetualang bersama kami di perpustakaan ini. Jalin koneksi dengan kata-kata, kisah-kisah, dan orang-orang yang memiliki semangat yang sama dalam mencari cahaya pengetahuan.</p>
              <p data-aos="fade-right" data-aos-delay="200" data-aos-offset="-500"><a href="{{ route('login2') }}" class="btn btn-outline-white">Login</a></p>
            </div>
